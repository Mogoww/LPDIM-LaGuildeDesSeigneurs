 ...
 */
final class Version20220214124055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE players (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(16) NOT NULL, lastname VARCHAR(16) NOT NULL, email VARCHAR(64) NOT NULL, mirian INT NOT NULL, identifier VARCHAR(40) NOT NULL, creation DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
